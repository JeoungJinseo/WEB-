...
- `lib/film-atmosphere.ts`: 정지 장면의 원본 영상 픽셀에 약 4.8초 주기의 가슴·어깨 호흡과 붉은 배경에만 보이는 상승 증기를 합성합니다. 얼굴 위쪽은 고정하고 몸통의 가로 확장은 0.9% 이내입니다. 영상 파일과 재생 시점은 변경하지 않습니다. 두 캔버스는 동일한 호흡 위상을 사용하며, 탭이 숨겨지거나 모션 감소 설정일 때 동작을 멈춥니다.
