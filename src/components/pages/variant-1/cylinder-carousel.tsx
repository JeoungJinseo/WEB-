  ...
  return (
    <div className={`oven-page${tubeIntro ? ' tube-journey-active' : ''}`} ref={rootRef}>
      ...
      <div className="sauna-scene" aria-label="OVEN SAUNA 원통형 그래픽 갤러리">
        {hasWebGL ? <canvas ref={canvasRef} role="img" aria-label="OVEN SAUNA의 열두 가지 그래픽으로 이루어진 회전하는 원통" /> : <img className="sauna-fallback" src={images[0]} alt="OVEN SAUNA — BEYOND THE HEAT 그래픽" />}
      </div>
