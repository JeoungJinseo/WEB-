...
for(const [width,height] of [[1440,1024],[1920,1080],[2560,1080],[1366,768],[844,390],[768,1024],[390,844],[375,667],[320,568]]){
 ...
 assert.ok(Math.abs(fit.compositionWidth-width)<.01||Math.abs(fit.compositionHeight-height)<.01,'the artwork uses all available width or height, including narrow panes');
